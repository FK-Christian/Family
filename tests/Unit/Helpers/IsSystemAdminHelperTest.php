...
class IsSystemAdminHelperTest extends TestCase
{
    ...
    public function user_is_an_admin()
    {
        ...
        $admin1 = factory(Family::class)->make(['email' => $adminEmail1]);
        $admin2 = factory(Family::class)->make(['email' => $adminEmail2]);
        $userWithEmail = factory(Family::class)->make(['email' => 'user@example.net']);
        $userWithNoEmail = factory(Family::class)->make(['email' => null]);
