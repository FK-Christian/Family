...
class Family extends Authenticatable {
    ...
    public function setFather(Family $father) {
    ...
    public function setMother(Family $mother) {
    ...
    public function childs() {
        if ($this->gender_id == 2) {
            return $this->hasMany(Family::class, 'mother_id')->orderBy('birth_order');
        }

        return $this->hasMany(Family::class, 'father_id')->orderBy('birth_order');
    }
    ...
    public function wifes() {
        return $this->belongsToMany(Family::class, 'couples', 'husband_id', 'wife_id')->using('App\CouplePivot')->withPivot(['id'])->withTimestamps()->orderBy('marriage_date');
    }

    public function addWife(Family $wife, $marriageDate = null) {
    ...
    public function husbands() {
        return $this->belongsToMany(Family::class, 'couples', 'wife_id', 'husband_id')->using('App\CouplePivot')->withPivot(['id'])->withTimestamps()->orderBy('marriage_date');
    }

    public function addHusband(Family $husband, $marriageDate = null) {
    ...
    public function hasBeenMarriedTo(Family $user) {
    ...
    public function siblings() {
        ...
        return Family::where('id', '!=', $this->id)
    ...
    public function managedUsers() {
        return $this->hasMany(Family::class, 'manager_id');
    }
